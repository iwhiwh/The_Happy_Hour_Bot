...
async def save_group(bot, message):
    ...
    if temp.ME in r_j_check:
        ...
        if message.chat.id in temp.BANNED_CHATS:
            ...
            buttons = [[
                InlineKeyboardButton('𝚂𝚄𝙿𝙿𝙾𝚁𝚃', url=f'https://t.me/The_Happy_Hour_Hindi')
            ]]
            ...
            return
        buttons = [[
            InlineKeyboardButton('𝙷𝙾𝚆 𝚃𝙾 𝚄𝚂𝙴 𝙼𝙴', url=f"https://t.me/The_Happy_Hour_Hindi"),
            InlineKeyboardButton('📢 UPDATES 📢', url='https://t.me/The_Happy_Hour_Hindi')
        ]]
        reply_markup=InlineKeyboardMarkup(buttons)
        ...
        if settings["welcome"]:
            for u in message.new_chat_members:
                ...
                video="https://telegra.ph/file/03691465baa774e46506d.mp4",                                               
                                                 ...
                                                 reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('🔥  ↭ Main Channel ↭  🔥', url='https://t.me/The_Happy_Hour_Hindi') ],
                                                                                      [ InlineKeyboardButton('🔥  ↭ 𝐒𝐮𝐩𝐩𝐨𝐫𝐭  ↭  🔥', url='https://t.me/The_Happy_Hour_Hindi') ]
                                                                                    ] )
                )
