...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
            ...
            [
                InlineKeyboardButton('⚡ Movie Updates ⚡', url=f"https://t.me/The_Happy_Hour_Hindi"),
            ],
            [
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('♥️ Movie Updates ♥️', url=f"https://t.me/The_Happy_Hour_Hindi"),
            InlineKeyboardButton('🔔 BOT Updates 🤖', url='https://t.me/The_Happy_Hour_Hindi')
            ],[
    ...
    await client.send_cached_media(
        ...
        file_id=file_id,
        caption=f_caption,
        reply_markup=InlineKeyboardMarkup( [ [InlineKeyboardButton('♥️𝐉𝐨𝐢𝐧 𝐂𝐡𝐚𝐧𝐧𝐞𝐥♥️'', url='https://t.me/The_Happy_Hour_Hindi')] ] ),
        protect_content=True if pre == 'filep' else False,
        )
