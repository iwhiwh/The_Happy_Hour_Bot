...
async def next_page(bot, query):
    ...
    btn.insert(0,
        [
            InlineKeyboardButton(text="♥️𝐣𝐨𝐢𝐧 𝐜𝐡𝐚𝐧𝐧𝐞𝐥♥️", url='https://t.me/The_Happy_Hour_Hindi')
        ]
    )
...
async def auto_filter(client, msg, spoll=False):
    ...
    btn.insert(0,
        [
            InlineKeyboardButton(text="♥️ 𝐣𝐨𝐢𝐧 𝐜𝐡𝐚𝐧𝐧𝐞𝐥 ♥️", url='https://t.me/The_Happy_Hour_Hindi')
        ]
    )
